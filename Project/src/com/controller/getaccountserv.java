 ...
 */
@WebServlet("/getaccountserv")
public class getaccountserv extends HttpServlet 
{
	/**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		request.getRequestDispatcher("acc(act-deact)nxt.jsp").forward(request,response);
		}
		else
