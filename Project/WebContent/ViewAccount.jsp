	...
	if(account!=null)
	{
      ...
      %> <br>  	<br><br>  
      	 <table border='1' width='100%' >  
    			 ...
    			 {
    			 long account_id=a.getAccount_id();%>
    			 
    				 <tr>
    				     <td><%out.println(a.getAccount_id());%></td>
    				     <td><%out.println(a.getAccount_type());%></td>
    				     <td><%out.println(a.getBalance());%></td>
    				      <td><a href="ViewTransaction?accountid=<%=account_id%>" style= "color: white" target="_blank" ><u>View Transaction</u></a></td>
