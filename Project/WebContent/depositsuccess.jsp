      ...
      <!--  <form name="forma">
		...
		function Redirect() {
            ...
            <section id="works" class="works" >
             ...
             <!--        <a href="cashiersecond.jsp" class="button">Back</a> -->
                       <!--  <h1 class="title wow fadeInDown" data-wow-delay=".3s"></h1> -->
                        <p class="wow fadeInDown" data-wow-delay=".5s">
						<h2>AMOUNT DEPOSITED SUCCESSFULLY!<BR>THANKYOU!</h2>
						<br><br><br><br>
						</p>
						<center>
							<div class="main-login3 main-center3">
								...
								<table class="table" BORDER="1">
									...
									<tr>
										...
										<td><%=(Integer) request.getSession().getAttribute("AMOUNT")+(Integer) request.getSession().getAttribute("BALANCE") %></td>
