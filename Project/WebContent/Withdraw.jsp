...
<body>
	...
	<form name="amount" action="withdrawserv" onsubmit=" return validateAmount()">
	<% 
				...
				<div class="col-md-6">
					<div class="block"> -->
						  ...
						  <div class="form-group">
							<label for="id" class="cols-sm-2 control-label">Customer Id</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="cid" id="cid"  value="<%=customerid %>" readonly/>
								</div>
							</div>
						</div><br><br>
						  ...
						  <div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="aid" id="aid"  value="<%=accountid %>" readonly/>
								</div>
							</div>
						</div><br><br>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<span class="input-group-addon"><i class="fa fa-user fa"
									...
									<input type="text" class="form-control" name="aid" id="aid"  value="<%=accounttype%>" readonly/>
							</div>
						</div>
					</div><br><br>
						  <div class="form-group">
							<label for="id" class="cols-sm-2 control-label">Amount to Withdraw</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="number" class="form-control" name="amt" id="amt"  placeholder="Enter Amount to Withdraw"/>
								</div>
							</div>
						</div><br><br>
						<div class="form-group ">
