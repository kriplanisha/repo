            ...
            <section id="works" class="works" >
                <div class="container">
                    <div class="section-heading">
                        <h1 class="title wow fadeInDown" data-wow-delay=".3s"> WELCOME! </h1>
                        <p class="wow fadeInDown" data-wow-delay=".5s">
                        <%String res= (String)request.getAttribute("result"); %>
                       <h2><b>SUCCESSFULLY REGISTERED WITH USER ID:<%=res  %></b></h2>
                       <br><br><h2><b>USER ID AND PASSWORD HAS BEEN SENT TO YOUR REGISTERED MAIL. </b></h2>
						</p>
