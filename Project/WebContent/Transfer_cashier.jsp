...
<script>
	function validateAmount() {
		...
		var match = document.amount.said.value;

		var phoneno = /^\d{9}$/;

		if (digit1 == match) {
			alert('source and destination account id cannot be same');
			return false;
		}
		...
		if (digit1 == " " || digit1 == "") {
			alert("Account Id can not be empty \n please enter the Account Id ");
			return false;
		} else if (!(digit1.match(phoneno))) {
			if (digit1 < 0) {
				alert("Account Id should  not contain negative values");
				return false;
			} else
				alert("Account Id should contain nine digit numerics");
			return false;
		}
...
<body>
	...
	<section id="works" class="works">
        ...
        ================================================== -->
					<form name="amount" action="accdetailserv2"	onsubmit="return validateAmount()">
						<%
						...
						%>
											...
											<div class="form-group">
												<label for="id" class="cols-sm-2 control-label">Source Customer Id</label>
												<div class="cols-sm-10">
													<div class="input-group">
														<span class="input-group-addon"><i
															class="fa fa-user fa" aria-hidden="true"></i></span> <input
															type="number" class="form-control" name="scid" id="scid"
											...
											<div class="form-group">
												<label for="id" class="cols-sm-2 control-label">Source
													Account Id</label>
												<div class="cols-sm-10">
													<div class="input-group">
														<span class="input-group-addon"><i
															class="fa fa-user fa" aria-hidden="true"></i></span> <input
															type="number" class="form-control" name="said" id="said"
											...
											<div class="form-group">
												<label for="name" class="cols-sm-2 control-label">
													Source Account Type</label>
												<div class="cols-sm-10">
													<div class="input-group">

														<span class="input-group-addon"><i
															class="fa fa-user fa" aria-hidden="true"></i></span> <input
															type="text" class="form-control" name="type1" id="type1"
											...
											<br> <br>
											<div class="form-group">
												<label for="id" class="cols-sm-2 control-label">Amount
													to Transfer</label>
												<div class="cols-sm-10">
													<div class="input-group">
														<span class="input-group-addon"><i
															class="fa fa-user fa" aria-hidden="true"></i></span> <input
															type="number" class="form-control" name="amt" id="amt"
											...
											<div class="form-group">
												<label for="id" class="cols-sm-2 control-label">Destination
													Account Id</label>
												<div class="cols-sm-10">
													<div class="input-group">
														<span class="input-group-addon"><i
