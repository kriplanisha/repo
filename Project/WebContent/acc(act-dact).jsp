  	 ...
  	 var phoneno = /^\d{9}$/; 
  	  ...
  	  if(digit==" " ||digit==""  )
         ...
         function validateAmount1(){
      		var digit1 = document.form2.Account_Id.value; 
						...
						<div class="row">
							<div class="col-sm-5">
								...
								<div class="main-login main-center">
									<form name="form1" action="getaccountserv" onsubmit="return validateAmount()">
									...
									<div class="col-sm-5">
										<div class="main-login main-center">
											<form name="form2" action="AccViewController"  method="post" onsubmit="return validateAmount1()">
												<div class="form-group">
													...
													<div class="cols-sm-10">
														<div class="input-group">
															<span class="input-group-addon"><i
																class="fa fa-user fa" aria-hidden="true"></i></span> <input
																type="text" class="form-control" name="Account_Id" id="Account_Id"
